...
export const fetchRegister = createAsyncThunk<LoginData, LoginData>('/auth/fetchRegister', async (params) => {
      const { data } = await axios.post<LoginData>("auth/register", params);
      return data;
})
